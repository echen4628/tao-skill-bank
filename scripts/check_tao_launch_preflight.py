...
def ssh_command(host: str, remote_command: str) -> list[str]:
    ...
    # Supported clusters may use csh/tcsh as their login shell. Keep POSIX
    # redirects, conditionals, variables, and quoting opaque to that shell and
    # let the documented bash boundary parse the probe instead.
