...
| `route_deft_od_aoi.py` | route | FN/FP dosing, DCT ranking, uniform top-up, admission, synthetic plan. |
...
| `deft_od_aoi_policy.py` | library | Policy construction, validation, uniform schedule, epoch budget. |
...
| Route / admit | `references/gap-routing.md`, `references/data-contract.md` | *(bundled — no miner skill)* | Pocket dosing, DCT rank, clean/near-miss/uniform branches. Glue: `route_deft_od_aoi.py`. |
